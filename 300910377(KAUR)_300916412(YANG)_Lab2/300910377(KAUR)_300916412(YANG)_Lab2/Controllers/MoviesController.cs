...
namespace _300910377_KAUR__300916412_YANG__Lab2.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(_300910377_KAUR__300916412_YANG__Lab2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MovieId,MovieName,FileName,Description")] Movie movie)
        {
