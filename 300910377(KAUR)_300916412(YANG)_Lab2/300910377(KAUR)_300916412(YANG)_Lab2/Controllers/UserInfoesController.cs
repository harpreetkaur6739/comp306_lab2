...
namespace _300910377_KAUR__300916412_YANG__Lab2.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public UserInfoesController(_300910377_KAUR__300916412_YANG__Lab2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,Email")] UserInfo userInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,Email")] UserInfo userInfo)
        {
