...
namespace _300910377_KAUR__300916412_YANG__Lab2.Controllers
{
    public class AssociationsController : Controller
    {
        ...
        public AssociationsController(_300910377_KAUR__300916412_YANG__Lab2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AssociationId,UserId,VideoId,CommentId")] Association association)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AssociationId,UserId,VideoId,CommentId")] Association association)
        {
